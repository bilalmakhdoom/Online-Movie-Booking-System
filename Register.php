...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from pixner.net/boleto/demo/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 16:34:45 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="container">
            <div class="padding-top padding-bottom">
                <div class="account-area">
                    ...
                    <form action="registerprocess.php" method="post" class="account-form">
                        <div class="form-group">
                            <label for="user_name">Name<span>*</span></label>
                            <input type="text" placeholder="Enter Your Name" id="user_name" name="user_name" required>
                        </div>
                        <div class="form-group">
