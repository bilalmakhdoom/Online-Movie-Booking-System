<?php 
    session_start();
    if(isset($_SESSION['guest_user']['id'])){
...
<!-- Mirrored from pixner.net/boleto/demo/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 16:34:45 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="container">
            <div class="padding-top padding-bottom">
                <div class="account-area">
                    ...
                    <form action="loginProcess.php" method="post" class="account-form">
