...
<!-- Mirrored from pixner.net/boleto/demo/sports-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 16:34:26 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="#0" class="active">Sport Checkout</a>
                            </li>
                        </ul>
                    </li>
                    <li>
